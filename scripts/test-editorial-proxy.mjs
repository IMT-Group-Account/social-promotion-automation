...
assert.equal((await fetch(`${origin}/api/backend/analytics/campaigns/00000000-0000-4000-8000-000000000000/dashboard`,{headers})).status,200);
assert.equal((await fetch(`${origin}/api/backend/operations/audit`,{headers})).status,200);
...
console.log('PASS 9 local BFF checks: session, proxy allowlist, analytics, operations, CSRF, upload size, logout, callback state.');
